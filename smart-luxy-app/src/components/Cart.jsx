...
export default function Cart({ open, items, total, onClose, onRemove, onChangeQty, onOrder }) {
  ...
  const [promoData, setPromoData]     = useState(null) // { code, reduction }
          ...
          <div className="cart-footer">
            ...
            <div style={{ marginBottom:14 }}>
              {!promoData ? (
                <>
                  ...
                  {promoError && (
                    <div style={{ fontSize:12, color:'#fca5a5', padding:'4px 2px' }}>❌ {promoError}</div>
                  )}
                </>
              ) : (
                <div style={{
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:5, marginBottom:12 }}>
              ...
              <div style={{
                ...
                <strong style={{ fontSize:20, color:'#C9A84C' }}>{fmt(totalFinal)}</strong>
              </div>
            </div>

            <button className="btn-confirm" onClick={() => onOrder(promoData, totalFinal)}>
