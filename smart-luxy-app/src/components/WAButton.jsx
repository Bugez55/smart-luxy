...
export default function WAButton() {
  ...
  useEffect(() => {
    // Se souvenir si l'utilisateur a fermé le bouton (ne pas le réafficher pendant sa session)
    if (sessionStorage.getItem('wa_closed') === '1') {
      setClosed(true)
      return
    }
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'relative' }}>
        {/* Bouton fermer — petite croix en haut à gauche du rond WhatsApp */}
        <button
          onClick={handleCloseButton}
          aria-label="Fermer le bouton WhatsApp"
          style={{
