// ══════════════════════════════════════════════
//  BOUTON WHATSAPP FLOTTANT — Smart Luxy
// ══════════════════════════════════════════════
import { useState, useEffect } from 'react'

const WA = import.meta.env.VITE_WA_NUMBER || '213556688810'
...
export default function WAButton() {
  ...
  useEffect(() => {
    ...
    // Cache le tooltip après 6 secondes
    const t2 = setTimeout(() => setTooltip(false), 9000)
    // Arrête le pulse après 10 secondes
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontSize: 12, color: '#aaa', cursor: 'pointer', lineHeight: 1,
            }}>✕</button>
